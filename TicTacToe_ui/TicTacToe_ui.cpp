...
//
//
//TicTacToe_ui::TicTacToe_ui(QWidget* parent)
//    : QMainWindow(parent)
//{
//    srand(time(0));
//    ui.setupUi(this);
...
//}
//
//void TicTacToe_ui::paintEvent(QPaintEvent* event)
//{
//    Q_UNUSED(event);
//
...
//    }
//}
//void TicTacToe_ui::paintWinner(int i)
//{
//    QPainter painter(this);
...
//    }
//}
//void TicTacToe_ui::onButtonClicked()
//{
//
...
//{}
//
//std::pair<uint8_t, uint8_t> TicTacToe_ui::Pickxy(QPushButton* button_aux)
//{
//    uint8_t x, y;
...
//}
//
//void TicTacToe_ui::DrawLabel(QPushButton* button_aux)
//{
